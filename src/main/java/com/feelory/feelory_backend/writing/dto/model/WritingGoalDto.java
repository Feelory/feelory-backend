package com.feelory.feelory_backend.writing.dto.model;
...
public class WritingGoalDto {
    ...
    public static WritingGoalDto fromEntity(com.feelory.feelory_backend.writing.entity.WritingGoal writingGoal) {
